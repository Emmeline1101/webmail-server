...
class Worker {
    ...
    listMessages(inCallOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (mailbox.exists === 0) {
                yield client.close(); // connection isn’t needed any longer
                return [];
            }
            const messages = yield client.listMessages(inCallOptions.mailbox, "1:*", // messages beginning with the first one and all messages after it
    ...
    deleteMessage(inCallOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            const client = yield this.connectToServer();
            yield client.deleteMessages(inCallOptions.mailbox, inCallOptions.id, {
                byUid: true,
            });
            yield client.close();
        });
